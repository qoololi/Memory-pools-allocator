...
Реализован аллокатор, работающий на основе выделенных заранее блоков памяти, соответсвующий [требованиям к аллокаторам](https://en.cppreference.com/w/cpp/named_req/Allocator).

Произведено сравнение со стандарным аллокатором при взаимодействии с контейнерами, полученные результаты изображены на графике. Изображена зависимость потраченного времени на добавление элемента в вектор, от количества добавленных элементов.
